...
export default function useContactAnimations(root: RefObject<HTMLElement | null>) {
  useEffect(() => {
    ...
    page.querySelectorAll<HTMLElement>(".contact-form, .contact-info").forEach(element => {
